...
* **Custom Visualizations:** Developed specific plots including site-specific boxplots (Argentina, Chile, Peru), activation state violin plots, and UMAPs showing activation signatures for CD4, CD8, and NK cells.
